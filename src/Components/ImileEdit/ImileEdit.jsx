...
export default function ImileEdit() {
  ...
  async function sendPricesToApi() {
    ...
    try {
      const {data} = await axios.post(`https://dashboard.go-tex.net/gotex-co-test/imile/edit`, Prices,
      {
        headers: {
            ...
            <div className=" py-3">
              <div className="edit-form">
                <div className="gray-box p-3">
                  <h5 className="text-center mb-3">أسعار شركة imile</h5>
