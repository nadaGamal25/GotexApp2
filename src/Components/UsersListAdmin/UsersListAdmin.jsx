...
const [marketerid, setMarketerid] = useState('');
      ...
      async function getUsersListsAdmin() {
        try {
          const response = await axios.get('https://dashboard.go-tex.net/gotex-co-test/admin/get-all-users',
          {
            headers: {
      ...
      async function addDepositToUser() {
        try {
          const response = await axios.post(
            'https://dashboard.go-tex.net/gotex-co-test/admin/add-deposit-to-user',
            {
              id: selectedUserId,
