...
export default function VerifyUser() {
    async function verifytUserAgain() {
        try {
          const response = await axios.get('https://dashboard.go-tex.net/gotex-co-test/user/resend-activate-code',
          {
            headers: {
  ...
  return (
    <>
    <div className="verify-container bg-light min-vh-100 d-flex justify-content-center align-items-center">
